...
import { getFlightPassengers, getFlightSeatDetails, storeSelectedPassengerDetails } from '../../actions/flight.actions';
                ...
                <div className="flight-seat-3">
                   <div className="flight-seat-31 row">
                    <div className="col-12 col-md-2 col-lg-2 col-xl-2 flight-seat-311">
                        <img className="image-2" alt="plane" src={require('../../assets/flight_black1.png')} />&nbsp;&nbsp;&nbsp;  <p className="ticket">A320|321</p>
                    </div>
                    <div style={{marginLeft: 40}} className="col-12 col-md-9 col-lg-9 col-xl-9 flight-seat-312">
                    <img className="image-5" alt="assigned icon" src={require('../../assets/icons8-ok-24.png')} />
                    <p className="paragraph-1">Selected Passenger</p> &nbsp;&nbsp;&nbsp;&nbsp;
                    <img className="image-5" alt="assigned icon" src={require('../../assets/icons8-filled-circle-24.png')} />
                    <p className="paragraph-1">Veg meal</p> &nbsp;&nbsp;&nbsp;&nbsp;
                    <img className="image-5" alt="assigned icon" src={require('../../assets/icons8-filled-circle-24 (3).png')} />
                    <p className="paragraph-1">Non Veg meal</p> &nbsp;&nbsp;&nbsp;&nbsp;
                    <img className="image-5" alt="assigned icon" src={require('../../assets/icons8-filled-circle-24 (1).png')} />
