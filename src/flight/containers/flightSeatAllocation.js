...
import './flightSeatAllocation.scss';
        ...
        return(
            <div className="flight-seat">
                ...
                <div className="flight-seat-2">
                    <p>{flightData.To_name}&nbsp;&nbsp;&nbsp;   {flightData.From_name}</p>
                </div>
                <div className="flight-seat-3">
                   <div className="flight-seat-31 row">
                    ...
                    <img className="image-5" alt="assigned icon" src={require('../../assets/filled-circle (2).png')} />
