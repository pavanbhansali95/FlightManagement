...
const FlightCard = (props) => {
  ...
  return(
    <Card style={{background: 'aliceblue'}} className="card">
    <div className="container-fluid card-wrapper">
      <div className="row ">

        <div className="text col-6 col-md-5 col-lg-5 col-xl-5">
          <img className="image" alt='imag' src='https://ramatniseko.com/wp-content/uploads/2012/07/Air-Asia.jpg'/><Typography className="text-1">{flightData.airlineName}</Typography>
